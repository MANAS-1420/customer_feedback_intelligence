...
CATEGORY_SUBCATEGORY_MAP = {
    ...
    "loan_finance": ["loan_approval_delay", "loan_rejected", "interest_rate_issue", "loan_disbursal_delay", "loan_disbursal_issue", "emi_calculation_issue", "foreclosure_issue", "penalty_charges", "documentation_issue", "kyc_issue", "recovery_agent_issue"],
